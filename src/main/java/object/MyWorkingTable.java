...
public class MyWorkingTable {
    public static void main(String[] args) {
        ...
        System.out.println("myFavoritePen.toString() = " + myFavoritePen.toString());
        ...
        System.out.println("myFavoritePen2.equals(myFavoritePen2) = " + myFavoritePen.equals(myFavoritePen2));
